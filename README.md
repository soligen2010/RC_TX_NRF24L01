...
TX for RC_RX_CABELL_V3_FHSS.  The MultiProtocol Module has a better Implementation and it what I now use instead of this Tx.  Uploaded this for reference in case someone finds it useful.

## License Info
Copyright 2016 - 2019 by Dennis Cabell (KE8FZX)
